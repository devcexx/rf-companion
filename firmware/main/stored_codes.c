...
static const clemsa_codegen_tx_t clemsa_code_home_exit = {
    ._generator = &clemsa_generator,
    .tx_name = "Home garage exit code",
    .code = HOME_GARAGE_EXIT_CODE,
    .code_len = CLEMSA_CODEGEN_DEFAULT_CODE_SIZE,
    .repetition_count = CLEMSA_DEFAULT_REPETITION_COUNT};

static const clemsa_codegen_tx_t clemsa_code_home_enter = {
    ._generator = &clemsa_generator,
    .tx_name = "Home garage enter code",
...
const rf_antenna_tx_t* stored_codes[STORED_CODES_COUNT] = {
  (rf_antenna_tx_t*) &clemsa_code_home_exit,
  (rf_antenna_tx_t*) &clemsa_code_home_enter,
